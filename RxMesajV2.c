...
unsigned char RxMesaj(unsigned char i){					// receptie mesaj															   
	unsigned char j, ch, sc, adresa_hw_src, screc, src, dest, lng, tipmes;
																				...
																				// nodul slave actualizeaza adresa masterului curent
																				...
																				// Altfel (mesajul este de interogare sau jeton)
			...
			return TMO;			// simuleaza lipsa unui raspuns	- dupa implementarea functiei se sterge linia																
}
